      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-16">
        ...
        >
          {visibleInsights.map((insight, index) => (
            <FadeIn key={insight.description} delay={index * 0.1}>
              <article className="group flex h-full flex-col overflow-hidden rounded-[18px] border border-[#E5E7EB] bg-white transition-all duration-300 motion-safe:hover:-translate-y-1 motion-safe:hover:shadow-[0_12px_28px_rgba(12,45,87,0.08)] sm:rounded-[20px]">
                <Link
                  href={insight.href}
