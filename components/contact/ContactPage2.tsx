  ...
  return (
    <div className="bg-[#F7F8FA] pt-[88px]">
      <div className="relative mx-auto max-w-[1440px] px-6 pt-[30px] lg:px-16">
        ...
        {/* Desktop contact details — kept left of the floating form */}
        <div className="hidden min-h-[420px] rounded-b-[24px] bg-white lg:block">
          <div className="mx-auto max-w-[1440px] px-6 pb-14 pt-16 lg:px-16">
            <div className="grid w-full max-w-[min(640px,calc(100%-480px))] grid-cols-2 gap-x-10 gap-y-10">
              <div className="flex flex-col">
                ...
                <div className="mt-2 flex min-h-9 items-center">
                  <a
                    ...
                    className="text-[16px] leading-[1.3] text-[#0c2d57] transition-opacity hover:opacity-80"
                  >
                    info@investera.com
                  </a>
                </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2 flex min-h-9 flex-nowrap items-center gap-2.5">
                  <a
                    href="https://www.linkedin.com/company/investera-ad/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="LinkedIn"
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#0c2d57] transition-opacity hover:opacity-90"
                  >
                    <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-white" aria-hidden>
                      ...
                      <path d="M10.5 13.2C11.2 11.9 12.4 10.8 14 10.8C16.2 10.8 17.2 12.3 17.2 14.5V18" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </a>
                  <a
                  ...
                  >
                    <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-white" aria-hidden>
                      ...
                      <path d="M12 10.2c-1.2 0-2.2 1-2.2 2.2S10.8 14.6 12 14.6s2.2-1 2.2-2.2S13.2 10.2 12 10.2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
                    </svg>
                  </a>
                  <a
                    ...
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#0c2d57] transition-opacity hover:opacity-90"
                  >
                    <svg viewBox="0 0 1226.37 1226.37" className="h-3.5 w-3.5 text-white" fill="currentColor" aria-hidden>
                  ...
                  >
                    <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-white" aria-hidden>
                      <path d="M21.6 8.2a2.6 2.6 0 0 0-1.8-1.9C18.1 6 12 6 12 6s-6.1 0-7.8.3A2.6 2.6 0 0 0 2.4 8.2 27 27 0 0 0 2 12a27 27 0 0 0 .4 3.8 2.6 2.6 0 0 0 1.8 1.9C5.9 18 12 18 12 18s6.1 0 7.8-.3a2.6 2.6 0 0 0 1.8-1.9A27 27 0 0 0 22 12a27 27 0 0 0-.4-3.8Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2 flex min-h-9 items-center">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2.5 text-[16px] leading-[1.3] text-[#0c2d57] transition-opacity hover:opacity-80"
                  >
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#0c2d57]">
                      <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-white" aria-hidden>
                        <path d="M12 3.5c-4.7 0-8.5 3.7-8.5 8.3 0 1.5.4 2.9 1.2 4.1L3.5 20.5l4.8-1.3c1.2.6 2.5 1 3.7 1 4.7 0 8.5-3.7 8.5-8.3S16.7 3.5 12 3.5Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
                        <path d="M9.3 9.4c.2-.4.4-.4.7-.4h.5c.2 0 .4 0 .5.3l.7 1.7c.1.2 0 .4-.1.5l-.4.5c-.1.1-.1.3 0 .4.4.7 1.1 1.4 1.9 1.8.2.1.3.1.4 0l.6-.4c.2-.1.4-.1.5 0l1.5.8c.2.1.3.3.2.5-.2.6-.8 1-1.4 1-.3 0-.6-.1-.9-.2-1.4-.5-2.7-1.4-3.7-2.6-.5-.6-.9-1.3-1.1-2-.1-.3-.2-.6-.2-.9 0-.5.2-1 .5-1.4Z" fill="currentColor" />
                      </svg>
                    </span>
                    +971 50 211 4603
                  </a>
      ...
      <div className="mx-auto max-w-[1440px] px-6 pb-10 pt-8 lg:hidden lg:px-16">
        <div className="grid grid-cols-1 gap-6 rounded-[16px] bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:grid-cols-2">
          <div>
            ...
            <a href="mailto:info@investera.com" className="mt-1 block text-[16px] text-[#0c2d57]">
              info@investera.com
            </a>
          </div>
          <div>
            <p className="text-[18px] font-semibold text-[#111111]">Phone</p>
            <a href="tel:+97123093880" className="mt-1 block text-[16px] text-[#0c2d57]">
              +971 2 309 3880
            </a>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2.5">
              ...
              >
                <svg viewBox="0 0 24 24" fill="none" className="h-4 w-4 text-white" aria-hidden>
                  <path
                    d="M21.6 8.2a2.6 2.6 0 0 0-1.8-1.9C18.1 6 12 6 12 6s-6.1 0-7.8.3A2.6 2.6 0 0 0 2.4 8.2 27 27 0 0 0 2 12a27 27 0 0 0 .4 3.8 2.6 2.6 0 0 0 1.8-1.9A27 27 0 0 0 22 12a27 27 0 0 0-.4-3.8Z"
                    stroke="currentColor"
                    strokeWidth="1.6"
                    strokeLinejoin="round"
                  />
